          ...
          <div class="col-md-7">
            <div class="card border-0 flex-md-row box-shadow h-md-250">
              <div class="card-body d-flex  flex-column align-items-start">
                ...
                <span class="text-primary ml-2">¥{{products[0].price.toFixed(2)}}</span>
                <router-link class="btn btn-primary ml-2" :to="products[0].href|getLid">查看详情</router-link>
              </div>
          ...
          <div class="col-md-5 pl-0">
            <div class="card border-0 flex-md-row box-shadow h-md-250">
              <div class="card-body d-flex flex-column align-items-start">
                ...
                <router-link class="btn btn-primary" :to="products[1].href|getLid">查看详情</router-link>
              </div>
        ...
        <div class="row mb-2">
          <div class="col-md-5">
            <div class="card border-0 flex-md-row box-shadow h-md-250">
              <div class="card-body d-flex flex-column align-items-start">
                ...
                <router-link class="btn btn-primary" :to="products[2].href|getLid">查看详情</router-link>
              </div>
          ...
          <div class="col-md-7 pl-0">
            <div class="row pr-3 pb-3">
              <div v-for="p of products.slice(3)" class="col-md-4 p-0 pl-2">
                <div class="card border-0 text-center pb-4 pt-2 ">
                  <img class="card-img-top" :src="p.pic" alt="Card image cap">
                  <div class="card-body p-0 pr-1 pl-1">
                    <h6 class="d-inline-block">{{p.title}}</h6>
                    <span class="text-primary small">¥{{p.price.toFixed(2)}}</span>
                    <router-link class="btn btn-sm btn-primary ml-2" :to="p.href|getLid">查看详情</router-link>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div class="row pr-3">
              <div class="col-md-4 p-0 pl-2">
                <div class="card border-0 text-center">
                  ...
                  <div class="card-body p-0 pr-1 pl-1 pb-4 pt-2">
                    <h6 class="d-inline-block">华硕RX310 金属超极本</h6>
                    <span class="text-primary small">¥4966.00</span>
                    <a class="btn btn-sm btn-primary ml-2" href="product_details.html?lid=13">查看详情</a>
                  </div>
                </div>
              </div>
              <div class="col-md-4 p-0 pl-2">
                <div class="card border-0 text-center">
                  ...
                  <div class="card-body p-0 pr-1 pl-1 pb-4 pt-2">
                    <h6 class="d-inline-block">联想小新700 电竞版游戏本</h6>
                    <span class="text-primary small">¥6299.00</span>
                    <a class="btn btn-sm btn-primary ml-2" href="product_details.html?lid=17">查看详情</a>
                  </div>
                </div>
              </div>
              <div class="col-md-4 p-0 pl-2">
                <div class="card border-0 text-center">
                  ...
                  <div class="card-body p-0 pr-1 pl-1 pb-4 pt-2">
                    <h6 class="d-inline-block">戴尔灵越燃7000 轻薄窄边</h6>
                    <span class="text-primary small">¥5199.00</span>
                    <a class="btn btn-sm btn-primary ml-2" href="product_details.html?lid=19">查看详情</a>
                  </div>
                </div>
              </div>
            </div>
...
<script>
    ...
    export default {
    	data:function(){
    		return {
    			products:[{price:0,href:''},{price:0,href:''},{price:0,href:''}]
    		}
    	},
    	mounted(){
